...
export const CardEvent = ({ name, date, location, total_tiket, total_view }: any) => {
  return (
    <div className="flex flex-col max-w-full gap-0 border rounded-md">
      <div className="relative p-0 mx-0">
        ...
        <span className="absolute flex items-center justify-center px-1 text-white bg-blue-400 rounded-md h-fit w-fit top-2 right-2">lock</span>
      </div>
